...
This matches the historical c64py loader-window bounds for the same N as the VICE “38911 vs 38913”
experiment (c64py’s C64PY_LOADER_* counters were removed in 2026-04). Pick N consistently on both sides
for comparable bounds.
