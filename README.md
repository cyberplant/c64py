...
- **Debug Support**: UDP debug logging and detailed debug output; Bruce Lee loader / VICE trace notes: [docs/bruce_lee_loader_investigation.md](docs/bruce_lee_loader_investigation.md) (roadmap: [docs/LOADER_DEBUG_PLAN.md](docs/LOADER_DEBUG_PLAN.md))
