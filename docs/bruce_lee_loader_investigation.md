...
> **Note (2026-04):** The c64py runtime hooks **`C64PY_BRUCELEE_*`** and **`C64PY_LOADER_*`** referenced below were **removed** from the tree. Use an older git revision to regenerate those logs; VICE-side scripts remain valid.
...
**`loader_branch_window.py`:** aligned slice of the same stream (e.g. around **`idx=105706`**):
